...
- Name: dashboard.spec.js >> CIRO Emergency Dashboard >> should trigger fraud alert on fake heatwave
- Location: e2e\dashboard.spec.js:20:3
...
Call log:
  - waiting for getByPlaceholder('e.g. huge fire at clifton')
